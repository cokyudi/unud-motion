...
<div class="wrapper">
          ...
          <!-- User Account: style can be found in dropdown.less -->
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="s2.jpg" class="user-image" alt="User Image">
                <span class="hidden-xs">Ecek</span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="s2.jpg" class="img-circle" alt="User Image">
        ...
        <table class="col-lg-5">
          ...
          <?php 
            while ($row=mysqli_fetch_row($result)) 
            {
             ...
             echo "<td><a href='hapususer.php?user=".$row[0]."'>Delete</a></td>";
  ...
  <footer class="main-footer">
    ...
    <strong><b>Unud M</b>otion</strong>
  </footer>
